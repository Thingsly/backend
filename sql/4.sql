-- Add password_last_updated column to the users table
...
VALUES('function_4', 'shared_account', 'enable', 'Shared Account', NULL);

-- Alter the action_param_type column in the action_info table to varchar(20)
ALTER TABLE "public"."action_info"
ALTER COLUMN "action_param_type" TYPE varchar(20) COLLATE "pg_catalog"."default";

-- Add last_visit_time column to the users table
ALTER TABLE public.users ADD last_visit_time timestamptz NULL;

-- Add comment to the last_visit_time column
COMMENT ON COLUMN public.users.last_visit_time IS 'Last visit time';
...
UPDATE public.sys_dict_language SET dict_id='7162fb9e-e3be-95d4-9c96-f18d1f9ddfcd', language_code='vi_VN', "translation"='Giao thức MQTT' WHERE id='001c3960-3067-536d-5c97-7645351a687c';
UPDATE public.sys_dict_language SET dict_id='0013fb9e-e3be-95d4-9c96-f18d1f9ddfcd', language_code='vi_VN', "translation"='Giao thức MQTT(Gateway)' WHERE id='002c3960-3067-536d-5c97-7645351a687b';
